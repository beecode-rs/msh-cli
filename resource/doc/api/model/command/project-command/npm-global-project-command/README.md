...
# model/command/project-command/npm-global-project-command

## Classes

- [NpmGlobalProjectCommand](classes/NpmGlobalProjectCommand.md)
...
- [VersionOnProjects](type-aliases/VersionOnProjects.md)

## Functions

- [npmGlobalProjectCommandFactory](functions/npmGlobalProjectCommandFactory.md)
